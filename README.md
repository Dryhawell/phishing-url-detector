...
**Current version:** `1.4.3` — see [CHANGELOG.md](CHANGELOG.md) · [Release](https://github.com/Dryhawell/phishing-url-detector/releases/tag/v1.4.3) · [Demo script](docs/DEMO_SCRIPT.md) · [Checklist](docs/CHECKLIST.md)
