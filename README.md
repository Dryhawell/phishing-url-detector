...
**Current version:** `1.4.2` — see [CHANGELOG.md](CHANGELOG.md) · [Release notes](docs/RELEASE_v1.4.2.md) · [Tags](https://github.com/Dryhawell/phishing-url-detector/tags) · [Checklist](docs/CHECKLIST.md)
